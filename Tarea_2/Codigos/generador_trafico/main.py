...
QUERIES = ["q1", "q2", "q3", "q5"] # Q4 se trata distinto por recibir dos zonas [cite: 37]
...
if __name__ == "__main__":
    ...
    # BUCLE INTELIGENTE: Reintenta hasta que Kafka esté UP de verdad
    while True:
        try:
